#ifndef BLACKDROPS_DART_SYSTEM_HPP
#define BLACKDROPS_DART_SYSTEM_HPP
...
namespace blackdrops {
    ...
    struct BasePolicyControl : public robot_dart::RobotControl {
    public:
        using robot_t = std::shared_ptr<robot_dart::Robot>;

        BasePolicyControl() {}
        BasePolicyControl(const std::vector<double>& ctrl, robot_t robot)
